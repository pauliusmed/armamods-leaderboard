...
- **Cloudflare Images transformations** — unikalios (paveikslėlis, parinktys) poros mokamos po 5k/mėn. Vienintiniai leidžiami `cf.image` taškai: `/api/mods/:id/thumbnail/img` (w ∈ {64,96,128}) ir `/api/img/proxy` (w ∈ {384,768,960,1200,1600,1920}); neleistinas `w` → 302 į kanoninį. Nauji transformacijos taškai — tik savininkui patvirtinus (detaliai `docs/COST_GUARDRAILS.md`). Senasis Pages projektas sunaikintas 2026-09-09 — jo neatkurti.
