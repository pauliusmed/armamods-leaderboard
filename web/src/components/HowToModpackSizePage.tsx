  ...
  return (
    <article className="max-w-3xl mx-auto space-y-10 animate-in fade-in duration-700 py-8">
      ...
      <nav className="flex flex-wrap items-center gap-x-3 gap-y-1 border-t border-white/10 pt-6 text-[9px] font-black uppercase tracking-widest" aria-label="Related tools">
        ...
        <Link to="/storage-planner" className="min-h-11 inline-flex items-center text-gray-400 transition-colors hover:text-tactical-orange">
          Open planner
        </Link>
        <span className="text-gray-700" aria-hidden="true">·</span>
        ...
        <span className="text-gray-700" aria-hidden="true">·</span>
        <Link to="/how-to-find-popular-arma-reforger-mods" className="min-h-11 inline-flex items-center text-gray-400 transition-colors hover:text-tactical-orange">
          Find popular mods
        </Link>
      </nav>
    </article>
