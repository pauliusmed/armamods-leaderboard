...
export function ReforgerHosting() {
  ...
  return (
    <div className="space-y-16 animate-in fade-in duration-700 pb-20">
      ...
      <GraphicHero
        eyebrow="// REFORGER MODDED OPERATIONS NODE"
        title={
          <>
            Reforger <span className="text-brand-mineral">Capacity Analysis</span>
          </>
        }
        description={`Plan modern modded operations around Enfusion hardware demands, with an interactive ${maxStableSlots}-slot stability baseline.`}
        ...
        <Card className="border-tactical-orange/20">
          ...
          <CardContent className="p-12 text-center space-y-8">
            ...
            <p className="text-gray-400 text-sm font-bold uppercase tracking-widest leading-relaxed max-w-2xl mx-auto">
              Reforger's dynamic entity system benefits from fast I/O and ample RAM. <span className="text-white">EmpowerServers</span> bills by resources rather than per slot, so cost scales with what you actually use instead of your player count.
            </p>
